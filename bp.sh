...
./$api cloud create aws       west2 --region=us-west-2 --keys=$HOME/.aws/aws.env
./$api cloud create aws       east2 --region=us-east-2 --keys=$HOME/.aws/aws.env --default-ssh-key=lussier-io-east2-key
