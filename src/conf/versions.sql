...
CREATE VIEW v_services AS
  SELECT t.sort_order as sort1, s.sort_order as sort2, t.svc_group, 
         ...
         s.service, p.port, p.image_file, p.project_url, 
	 p.description
...
INSERT INTO versions VALUES ('hub', '7.02', '',  1, '20210401', '', '', '');
INSERT INTO versions VALUES ('hub', '7.01', '',  0, '20210305', '', '', '');
INSERT INTO versions VALUES ('hub', '7.00', '',  0, '20210212', '', '', '');
